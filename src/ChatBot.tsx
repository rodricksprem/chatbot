...
export default class ChatBot extends React.Component<any,any> {
          ...
          <div className="fqXYVo">
            <img
              ...
              style={{ 'margin': '0px',
                ...
                'height': '100%',
                'width': '100%',
                'border-radius': '40px'} as React.CSSProperties}></img>
          </div>
  ...
  >
    ...
    >
      <g style={{'fill': 'rgb(255, 255, 255)' } as React.CSSProperties}>
        <polygon
          points="0 14.0186916 14.0186916 0 15 0.981308396 0.981308396 15"
        ></polygon>
        <polygon
          points="0.981308396 0 15 14.0186916 14.0186916 15 0 0.981308396"
        ></polygon>
      </g>
    </svg>
  </div>
  ...
  <div className="hiYdui">
    <div className="cOALSM">
      <textarea
        ...
        tabIndex={1}
        className="kTlUVN"
        style={{'height': '35px'} as React.CSSProperties}></textarea>
    </div>
    <button
      tabIndex={2}
      title="Send message"
    ...
    >
      <svg
        ...
        height="14"
        viewBox="0 0 22 17"
        style={{'transform': 'scale(1.35, 1.35)'}as React.CSSProperties }
      >
        <g>
          <g>
            <path
              ...
              style={{'fill':  'rgb(1, 60, 103)'}as React.CSSProperties }
            ></path>
          </g>
        </g>
      </svg>
